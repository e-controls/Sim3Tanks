...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @gui_help_OpeningFcn, ...
    'gui_OutputFcn',  @gui_help_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function varargout = gui_help_OutputFcn(~, ~, handles)

varargout{1} = handles.output;

function gui_help_OpeningFcn(hObject, ~, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

set(handles.help_figure,'Name','Help');
movegui(gcf,'center');
...
delete(findobj('Tag','help_figure'));
