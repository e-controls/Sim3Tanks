function [uk] = level_pid_controller(setpoint, Qp, yk)

if(get_k() == 1)
    
    % Previous signals: e = [e1(k-1) e1(k-2) ; e2(k-1) e2(k-2)] , u = [u1(k-1) u1(k-2) ; u2(k-1) u2(k-2)]
    e = [0 0 ; 0 0];
    u = [0 0 ; 0 0];
    ...
    % PID to tank 1
    u1 = u(1,2) + a0*ek(1) + a1*e(1,1) + a2*e(1,2);
    u1 = mysaturation(u1, 0, Qp(1));
    
    % PID to tank 2
    u2 = u(2,2) + a0*ek(2) + a1*e(2,1) + a2*e(2,2);
